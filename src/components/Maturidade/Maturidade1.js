                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option value="opcao1" 
                                    title="Nível 1: A estrutura organizacional da empresa é pouco definida 
                                    e não é adequada para suportar as atividades e fluxos de trabalho. Há falta de clareza nas 
                                    responsabilidades e comunicação ineficiente entre os membros da equipe.">Nível 1: 
                                    A estrutura organizacional da empresa é pouco definida 
                                    e não é adequada para suportar as atividades e fluxos de trabalho. Há falta de clareza nas 
                                    responsabilidades e comunicação ineficiente entre os membros da equipe.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: A estrutura organizacional da empresa está sendo desenvolvida, 
                                    ...
                                    eficiência das atividades e fluxos de trabalho.">Nível 2: A estrutura 
                                    organizacional da empresa está sendo desenvolvida, 
                                    mas ainda apresenta algumas deficiências. Existem departamentos definidos, mas a coordenação 
                                    entre eles pode ser aprimorada para melhorar a 
                                    eficiência das atividades e fluxos de trabalho.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: A estrutura organizacional da empresa é bem definida e adequada 
                                    para suportar as atividades e fluxos de trabalho. Os departamentos estão claramente estabelecidos, 
                                    a comunicação é eficiente e as responsabilidades são bem distribuídas.">Nível 3: 
                                    A estrutura organizacional da empresa é bem definida e adequada 
                                    para suportar as atividades e fluxos de trabalho. Os departamentos estão claramente estabelecidos, 
                                    a comunicação é eficiente e as responsabilidades são bem distribuídas.</option>
                                    <option value="opcao4" 
                                    title="Nível 4:A estrutura organizacional da empresa é altamente desenvolvida 
                                    ...
                                    em todos os níveis da organização.">Nível 4:A estrutura organizacional da empresa é altamente desenvolvida 
                                    e otimizada para suportar as atividades e fluxos de trabalho. Os processos são eficientes, 
                                    os departamentos estão interligados de forma integrada e a comunicação é transparente 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1:Planejamento estratégico pouco estruturado ou inexistente, 
                                    com falta de metas claras e direção estratégica comprometida.">Nível 1: 
                                    Planejamento estratégico pouco estruturado ou inexistente, 
                                    com falta de metas claras e direção estratégica comprometida.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Planejamento estratégico em desenvolvimento, mas falta 
                                    abrangência e clareza nas metas, comprometendo a efetividade.">Nível 2: 
                                    Planejamento estratégico em desenvolvimento, mas falta 
                                    abrangência e clareza nas metas, comprometendo a efetividade.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Planejamento estratégico estabelecido, porém, implementação e 
                                    acompanhamento podem ser aprimorados para alcançar metas consistentemente.">Nível 3: 
                                    Planejamento estratégico estabelecido, porém, implementação e 
                                    acompanhamento podem ser aprimorados para alcançar metas consistentemente.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Planejamento estratégico bem definido, com metas claras e um
                                     sistema robusto de acompanhamento e revisão para manter alinhamento e ajustes necessários.">Nível 4: 
                                     Planejamento estratégico bem definido, com metas claras e um
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Processos administrativos pouco definidos, documentados ou 
                                    padronizados, resultando em inconsistências e falta de eficiência.">Nível 1: 
                                    Processos administrativos pouco definidos, documentados ou 
                                    padronizados, resultando em inconsistências e falta de eficiência.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Alguns processos administrativos estão documentados, 
                                    mas padronização não é completa, causando variações e impactando consistência e eficiência.">Nível 2: 
                                    Alguns processos administrativos estão documentados, 
                                    mas padronização não é completa, causando variações e impactando consistência e eficiência.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Maioria dos processos administrativos documentados e 
                                    padronizados, esforço para consistência e eficiência nas tarefas.">Nível 3: 
                                    Maioria dos processos administrativos documentados e 
                                    padronizados, esforço para consistência e eficiência nas tarefas.</option>
                                    <option value="opcao4" 
                                    title ="Nível 4: Todos os processos administrativos claramente 
                                    documentados e padronizados, com foco na eficiência, 
                                    melhoria contínua e monitoramento regular.">Nível 4: 
                                    Todos os processos administrativos claramente 
                                    documentados e padronizados, com foco na eficiência, 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Gestão de projetos pouco estruturada ou inexistente, 
                                    sem metodologias ou ferramentas específicas, resultando em falta de controle 
                                    e coordenação efetiva.">Nível 1: Gestão de projetos pouco estruturada ou inexistente, 
                                    sem metodologias ou ferramentas específicas, resultando em falta de controle 
                                    e coordenação efetiva.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Gestão de projetos em desenvolvimento, com uso parcial ou 
                                    inconsistente de metodologias e ferramentas, limitando a eficácia.">Nível 2: 
                                    Gestão de projetos em desenvolvimento, com uso parcial ou 
                                    inconsistente de metodologias e ferramentas, limitando a eficácia.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Abordagem estruturada para gestão de projetos, com metodologias e 
                                    ferramentas estabelecidas, planejamento adequado e monitoramento efetivo">Nível 3: 
                                    Abordagem estruturada para gestão de projetos, com metodologias e 
                                    ferramentas estabelecidas, planejamento adequado e monitoramento efetivo.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Gestão de projetos altamente desenvolvida e eficiente, com uso de 
                                    metodologias avançadas (PMBOK, Agile, Scrum), capacitação 
                                    constante dos profissionais envolvidos.">Nível 4: Gestão de projetos altamente
                                     desenvolvida e eficiente, com uso de 
                                    metodologias avançadas (PMBOK, Agile, Scrum), capacitação 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Gestão financeira pouco estruturada ou inexistente, resultando 
                                    em falta de controle, dificuldades na previsão e possíveis problemas de liquidez
                                    .">Nível 1: Gestão financeira pouco estruturada ou inexistente, resultando 
                                    em falta de controle, dificuldades na previsão e possíveis problemas de liquidez.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Gestão financeira em desenvolvimento, com algum controle, mas é 
                                    necessário aprimorar processos e ferramentas para eficácia.">Nível 2: Gestão financeira em 
                                    desenvolvimento, com algum controle, mas é 
                                    necessário aprimorar processos e ferramentas para eficácia.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Controle efetivo do orçamento, fluxo de caixa e contas a pagar/receber, 
                                    utilizando ferramentas e práticas adequadas de gestão financeira.">Nível 3: 
                                    Controle efetivo do orçamento, fluxo de caixa e contas a pagar/receber, 
                                    utilizando ferramentas e práticas adequadas de gestão financeira.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Gestão financeira altamente desenvolvida e eficiente, com controle 
                                    preciso e atualizado, uso de ferramentas avançadas e análises para 
                                    decisões estratégicas embasadas.">Nível 4: Gestão financeira altamente desenvolvida e eficiente, com controle 
                                    preciso e atualizado, uso de ferramentas avançadas e análises para 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                        ...
                                        <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Qualidade baixa ou inconsistente nos produtos/serviços, falta de 
                                    indicadores e processos de melhoria contínua. Risco de insatisfação dos clientes e perda de 
                                    competitividade.">Nível 1: Qualidade baixa ou inconsistente nos produtos/serviços, falta de 
                                    indicadores e processos de melhoria contínua. Risco de insatisfação dos clientes e perda de 
                                    competitividade. </option>
                                    <option value="opcao2" 
                                    title="Nível 2: Desenvolvimento da qualidade em andamento, com indicadores em progresso, 
                                    porém, não totalmente estabelecidos. Implementação parcial ou inconsistente de processos de melhoria 
                                    contínua.">Nível 2: Desenvolvimento da qualidade em andamento, com indicadores em progresso, 
                                    porém, não totalmente estabelecidos. Implementação parcial ou inconsistente de processos de melhoria 
                                    contínua.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Adequado nível de qualidade em produtos/serviços. Uso de indicadores 
                                    estabelecidos, monitoramento e ações corretivas. Processos de melhoria contínua em vigor para 
                                    aprimoramento constante.">Nível 3: Adequado nível de qualidade em produtos/serviços. Uso de indicadores 
                                    estabelecidos, monitoramento e ações corretivas. Processos de melhoria contínua em vigor para 
                                    aprimoramento constante.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Alto nível de qualidade em produtos/serviços. Indicadores sofisticados,
                                     cultura de melhoria contínua enraizada em todos os níveis. Incentivo à inovação e aprimoramento 
                                     constante.">Nível 4: Alto nível de qualidade em produtos/serviços. Indicadores sofisticados,
                                     cultura de melhoria contínua enraizada em todos os níveis. Incentivo à inovação e aprimoramento 
                                     constante.</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" title="Nível 1: Gestão de documentos e arquivos pouco estruturada ou inexistente, 
                                    resultando em dificuldades na localização e recuperação de informações importantes.">Nível 1:
                                     Gestão de documentos e arquivos pouco estruturada ou inexistente, 
                                    resultando em dificuldades na localização e recuperação de informações importantes. </option>
                                    <option value="opcao2" title="Nível 2: Desenvolvimento da gestão de documentos e arquivos em andamento, com 
                                    práticas de organização e armazenamento parciais ou pouco eficientes.">Nível 2: Desenvolvimento da 
                                    gestão de documentos e arquivos em andamento, com 
                                    práticas de organização e armazenamento parciais ou pouco eficientes.</option>
                                    <option value="opcao3" title="Nível 3: Práticas adequadas de gestão de documentos e arquivos, com sistemas e
                                     procedimentos estabelecidos para organização e recuperação eficiente das informações.">Nível 3: 
                                     Práticas adequadas de gestão de documentos e arquivos, com sistemas e
                                     procedimentos estabelecidos para organização e recuperação eficiente das informações.</option>
                                    <option value="opcao4" title="Nível 4: Gestão de documentos e arquivos altamente desenvolvida e eficiente, 
                                    com uso de práticas avançadas, tecnologias como GED e sistemas digitais, garantindo organização e 
                                    acesso rápido às informações.">Nível 4: Gestão de documentos e arquivos altamente desenvolvida e eficiente, 
                                    com uso de práticas avançadas, tecnologias como GED e sistemas digitais, garantindo organização e 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" title="Nível 1: Gestão de riscos pouco estruturada ou inexistente, falta de 
                                    análises sistemáticas e planos de contingência. Maior exposição a riscos e falta de preparação para 
                                    eventos adversos.">Nível 1: Gestão de riscos pouco estruturada ou inexistente, falta de 
                                    análises sistemáticas e planos de contingência. Maior exposição a riscos e falta de preparação para 
                                    eventos adversos. </option>
                                    <option value="opcao2" title="Nível 2: Desenvolvimento da gestão de riscos em andamento, com análises ad hoc 
                                    e planos de contingência limitados. Ainda não abrangente ou sistemático.">Nível 2: 
                                    Desenvolvimento da gestão de riscos em andamento, com análises ad hoc 
                                    e planos de contingência limitados. Ainda não abrangente ou sistemático.</option>
                                    <option value="opcao3" title="Nível 3: Gestão de riscos adequada, com análises regulares e abrangentes, 
                                    identificação e avaliação dos principais riscos. Planos de contingência estabelecidos para resposta 
                                    efetiva.">Nível 3: Gestão de riscos adequada, com análises regulares e abrangentes, 
                                    identificação e avaliação dos principais riscos. Planos de contingência estabelecidos para resposta 
                                    efetiva. </option>
                                    <option value="opcao4" title="Nível 4: Gestão de riscos altamente desenvolvida, com análises avançadas, 
                                    metodologias como análise quantitativa e planos de contingência sólidos. Cultura de conscientização e 
                                    monitoramento contínuo dos riscos.">Nível 4: Gestão de riscos altamente desenvolvida, com análises avançadas, 
                                    metodologias como análise quantitativa e planos de contingência sólidos. Cultura de conscientização e 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" title="Nível 1: Gestão do tempo e produtividade inexistente. Falta de monitoramento e 
                                    incentivo à eficiência. Baixa produtividade e possíveis atrasos nos projetos.">
                                        Nível 1: Gestão do tempo e produtividade inexistente. Falta de monitoramento e 
                                    incentivo à eficiência. Baixa produtividade e possíveis atrasos nos projetos. </option>
                                    <option value="opcao2" title="Nível 2: Desenvolvimento da gestão do tempo e produtividade em andamento. Algumas 
                                    práticas de monitoramento, porém não abrangentes. Incentivo à eficiência inconsistente.">Nível 2: 
                                    Desenvolvimento da gestão do tempo e produtividade em andamento. Algumas 
                                    práticas de monitoramento, porém não abrangentes. Incentivo à eficiência inconsistente.</option>
                                    <option value="opcao3" title="Nível 3: Práticas adequadas de gestão do tempo e produtividade. Uso de ferramentas
                                     de monitoramento e metas claras. Incentivo à eficiência com reconhecimento e recompensas.">Nível 3: 
                                     Práticas adequadas de gestão do tempo e produtividade. Uso de ferramentas
                                     de monitoramento e metas claras. Incentivo à eficiência com reconhecimento e recompensas. </option>
                                    <option value="opcao4" title="Nível 4: Gestão do tempo e produtividade altamente eficiente. Uso de ferramentas 
                                    avançadas e metodologias como gerenciamento de fluxo de trabalho. Cultura de eficiência e incentivos para
                                    alto desempenho.">Nível 4: Gestão do tempo e produtividade altamente eficiente. Uso de ferramentas 
                                    avançadas e metodologias como gerenciamento de fluxo de trabalho. Cultura de eficiência e incentivos para
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" title="Nível 1: A empresa carece de um canal de comunicação interna efetivo ou 
                                    inexistente, resultando em colaboradores desinformados e pouco envolvidos nas decisões administrativas,
                                     prejudicando o engajamento e motivação.">Nível 1: A empresa carece de um canal de 
                                     comunicação interna efetivo ou 
                                    inexistente, resultando em colaboradores desinformados e pouco envolvidos nas decisões administrativas,
                                     prejudicando o engajamento e motivação. </option>
                                    <option value="opcao2" title="Nível 2: A empresa busca melhorar sua comunicação interna, mas ainda está em 
                                    desenvolvimento. Colaboradores têm níveis variados de envolvimento e informação sobre decisões 
                                    administrativas.">Nível 2: A empresa busca melhorar sua comunicação interna, mas ainda está em 
                                    desenvolvimento. Colaboradores têm níveis variados de envolvimento e informação sobre decisões 
                                    administrativas.</option>
                                    <option value="opcao3" title="Nível 3: A empresa tem canal de comunicação interno adequado, com boletins, 
                                    reuniões e intranet, mantendo colaboradores informados e engajados, com espaço para feedback.">Nível 3: 
                                    A empresa tem canal de comunicação interno adequado, com boletins, 
                                    reuniões e intranet, mantendo colaboradores informados e engajados, com espaço para feedback.</option>
                                    <option value="opcao4" title="Nível 4: A empresa usa canais internos efetivos, incluindo tecnologias avançadas, 
                                    para garantir comunicação eficiente. Colaboradores se sentem envolvidos, informados e incentivados a 
                                    participar ativamente da tomada de decisão. Cultura de transparência e abertura é promovida.">Nível 4:
                                     A empresa usa canais internos efetivos, incluindo tecnologias avançadas, 
                                    para garantir comunicação eficiente. Colaboradores se sentem envolvidos, informados e incentivados a 
