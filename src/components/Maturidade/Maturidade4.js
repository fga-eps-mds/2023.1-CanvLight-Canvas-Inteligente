                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option value="opcao1" 
                                    title="Nível 1: Estratégia de marketing pouco definida ou 
                                    inexistente, resultando em falta de direção e foco nas ações de marketing.">Nível 1: 
                                    Estratégia de marketing pouco definida ou 
                                    inexistente, resultando em falta de direção e foco nas ações de marketing.
                                    </option>
                                    <option value="opcao2" 
                                    title="Nível 2: Em desenvolvimento da estratégia de marketing,
                                     com elementos parciais definidos, mas ainda não abrangentes ou consistentes.">Nível 2: 
                                     Em desenvolvimento da estratégia de marketing,
                                     com elementos parciais definidos, mas ainda não abrangentes ou consistentes.
                                    </option>
                                    <option value="opcao3" 
                                    title="Nível 3: Estratégia de marketing claramente definida,
                                     com objetivos específicos e mensuráveis, abrangendo segmentação, posicionamento e
                                      canais de comunicação.">Nível 3: Estratégia de marketing claramente definida,
                                     com objetivos específicos e mensuráveis, abrangendo segmentação, posicionamento e
                                      canais de comunicação.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Estratégia de marketing altamente desenvolvida e
                                     eficaz, alinhada com os objetivos organizacionais. Inclui abordagens avançadas de
                                      segmentação, branding, comunicação integrada e mensuração de resultados. Busca
                                       constante de inovação e adaptação para se manter competitiva.">Nível 4: 
                                       Estratégia de marketing altamente desenvolvida e
                                     eficaz, alinhada com os objetivos organizacionais. Inclui abordagens avançadas de
                                      segmentação, branding, comunicação integrada e mensuração de resultados. Busca
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Pouca definição e segmentação do público-alvo, 
                                    comunicação genérica e escolha inconsistente dos canais de marketing.">Nível 1: 
                                    Pouca definição e segmentação do público-alvo, 
                                    comunicação genérica e escolha inconsistente dos canais de marketing.
                                    </option>
                                    <option value="opcao2" 
                                    title="Nível 2: Em processo de desenvolvimento na definição e
                                    segmentação do público-alvo, com algum entendimento básico dos perfis dos clientes. 
                                    Escolha de canais baseada em suposições ou experiências passadas.">Nível 2: 
                                    Em processo de desenvolvimento na definição e
                                    segmentação do público-alvo, com algum entendimento básico dos perfis dos clientes. 
                                    Escolha de canais baseada em suposições ou experiências passadas.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Definição clara e segmentação do público-alvo,
                                     ...
                                     alinhada ao público-alvo.">Nível 3: Definição clara e segmentação do público-alvo,
                                     identificando perfis de clientes com base em dados demográficos, comportamentais e 
                                     preferências. Escolha estratégica dos canais de marketing 
                                     alinhada ao público-alvo.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Definição e segmentação avançada do 
                                    público-alvo, incluindo dados detalhados e personalizados. Escolha estratégica dos
                                     ...
                                     inovação em novos canais e tecnologias.">Nível 4: Definição e segmentação avançada do 
                                    público-alvo, incluindo dados detalhados e personalizados. Escolha estratégica dos
                                     canais de marketing considerando a jornada do cliente. Busca constante por 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    pesquisa de mercado, feedback dos clientes e busca constante por inovação.">Nível 4: 
                                    Processo avançado e bem definido 
                                    para o desenvolvimento de produtos ou serviços, abrangendo todas as etapas desde a 
                                    geração de ideias até o lançamento no mercado. Baseado em análise de dados, 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Ausência de estratégias de preço claras, resultando
                                     em determinação arbitrária dos preços sem análise adequada de custos e concorrência.">Nível 1: 
                                     Ausência de estratégias de preço claras, resultando
                                     em determinação arbitrária dos preços sem análise adequada de custos e concorrência.
                                    </option>
                                    <option value="opcao2" 
                                    title="Nível 2: Adoção de estratégias de preço básicas, baseadas nos 
                                    custos de produção, mas sem considerar fatores externos ou percepção de valor pelo
                                     cliente.">Nível 2: Adoção de estratégias de preço básicas, baseadas nos 
                                    custos de produção, mas sem considerar fatores externos ou percepção de valor pelo
                                     cliente.
                                    </option>
                                    <option value="opcao3" 
                                    title="Nível 3: Utilização de estratégias de preço mais avançadas, 
                                    considerando não apenas os custos, mas também a concorrência e a demanda de mercado.
                                     Porém, há espaço para aprimoramentos na análise de precificação.">Nível 3: 
                                     Utilização de estratégias de preço mais avançadas, 
                                    considerando não apenas os custos, mas também a concorrência e a demanda de mercado.
                                     Porém, há espaço para aprimoramentos na análise de precificação.
                                    </option>
                                    <option value="opcao4" 
                                    title="Estratégias de preço bem definidas e alinhadas com os 
                                    objetivos de negócio. Determinação dos preços dos produtos ou serviços por meio de
                                     ...
                                     atender às necessidades dos clientes de forma eficaz.">Nível 4: Estratégias de preço bem 
                                     definidas e alinhadas com os 
                                    objetivos de negócio. Determinação dos preços dos produtos ou serviços por meio de
                                     uma análise abrangente que considera custos, concorrência, valor percebido pelo 
                                     cliente e segmentação de mercado. Essa abordagem permite maximizar os lucros e 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Ausência de estratégias de promoção definidas ou 
                                    consistentes para divulgar produtos ou serviços.">Nível 1: Ausência de estratégias
                                     de promoção definidas ou 
                                    consistentes para divulgar produtos ou serviços..</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Utilização de estratégias de promoção básicas, como 
                                    anúncios genéricos dispersos em diferentes canais de comunicação.">Nível 2: Utilização de 
                                    estratégias de promoção básicas, como 
                                    anúncios genéricos dispersos em diferentes canais de comunicação.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Adoção de estratégias de promoção mais direcionadas, 
                                    como publicidade segmentada, parcerias com influenciadores ou participação em eventos 
                                    específicos.">Nível 3: Adoção de estratégias de promoção mais direcionadas, 
                                    como publicidade segmentada, parcerias com influenciadores ou participação em eventos 
                                    específicos.
                                    </option>
                                    <option value="opcao4" 
                                    title="Nível 4: Utilização de uma ampla variedade de estratégias de 
                                    ...
                                    alcançar o público-alvo de maneira eficiente e abrangente.">Nível 4: Utilização de 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Pouca compreensão do tamanho e dinâmica do mercado, 
                                    falta de análise aprofundada e conhecimento sobre oportunidades e ameaças.">Nível 1:
                                     Pouca compreensão do tamanho e dinâmica do mercado, 
                                    falta de análise aprofundada e conhecimento sobre oportunidades e ameaças. 
                                    </option>
                                    <option value="opcao2" 
                                    title="Nível 2: Em desenvolvimento na compreensão do mercado, noção 
                                    geral, análise ad hoc e identificação de tendências.">Nível 2: 
                                    Em desenvolvimento na compreensão do mercado, noção 
                                    geral, análise ad hoc e identificação de tendências.
                                    </option>
                                    <option value="opcao3" 
                                    title="Nível 3: Compreensão adequada do mercado, análises regulares, 
                                    consideração das tendências na formulação de estratégias.">Nível 3: 
                                    Compreensão adequada do mercado, análises regulares, 
                                    consideração das tendências na formulação de estratégias.
                                    </option>
                                    <option value="opcao4" 
                                    title="Nível 4: Compreensão avançada e profunda do mercado, análises 
                                    detalhadas, monitoramento constante das tendências e antecipação das necessidades dos 
                                    clientes.">Nível 4: Compreensão avançada e profunda do mercado, análises 
                                    detalhadas, monitoramento constante das tendências e antecipação das necessidades dos 
                                    clientes.</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1:  Falta de análise dos principais concorrentes e 
                                    posicionamento indefinido em relação a eles.">Nível 1:  
                                    Falta de análise dos principais concorrentes e 
                                    posicionamento indefinido em relação a eles.</option>
                                    <option value="opcao2" 
                                    title="Nível 2:  Identificação limitada dos concorrentes, entendimento
                                     básico de suas estratégias e posicionamento não claro.">Nível 2:  
                                     Identificação limitada dos concorrentes, entendimento
                                     básico de suas estratégias e posicionamento não claro.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Conhecimento dos principais concorrentes, compreensão
                                     das estratégias básicas e posicionamento diferenciado em desenvolvimento.">Nível 3: 
                                     Conhecimento dos principais concorrentes, compreensão
                                     das estratégias básicas e posicionamento diferenciado em desenvolvimento.
                                     </option>
                                    <option value="opcao4" 
                                    title="Nível 4: Análise detalhada dos concorrentes, profundo 
                                    entendimento de suas estratégias e posicionamento claro e diferenciado para se 
                                    destacar e aproveitar oportunidades competitivas.">Nível 4: Análise detalhada dos concorrentes, 
                                    profundo 
                                    entendimento de suas estratégias e posicionamento claro e diferenciado para se 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Ausência de pesquisas de mercado e coleta de 
                                    dados sobre o comportamento dos consumidores.">Nível 1: 
                                    Ausência de pesquisas de mercado e coleta de 
                                    dados sobre o comportamento dos consumidores.</option>
                                    <option value="opcao2" 
                                    title="Nível 2: Pesquisas de mercado ocasionais, sem um processo
                                    estruturado de coleta de dados sobre o comportamento dos consumidores.">Nível 2: 
                                    Pesquisas de mercado ocasionais, sem um processo
                                    estruturado de coleta de dados sobre o comportamento dos consumidores.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Pesquisas de mercado regulares, com coleta de 
                                    dados sobre o comportamento dos consumidores, mas utilização limitada nas 
                                    estratégias de marketing.">Nível 3: Pesquisas de mercado regulares, com coleta de 
                                    dados sobre o comportamento dos consumidores, mas utilização limitada nas estratégias de marketing. </option>
                                    <option value="opcao4" 
                                    title="Nível 4: Processo estruturado de pesquisas de mercado, 
                                    coleta sistemática de dados sobre o comportamento dos consumidores e uso eficiente
                                     ...
                                     relevantes.">Nível 4: Processo estruturado de pesquisas de mercado, 
                                    coleta sistemática de dados sobre o comportamento dos consumidores e uso eficiente
                                     dessas informações para direcionar as estratégias de marketing e tomar decisões 
                                     relevantes.</option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1:  Ausência de indicadores de desempenho
                                     para avaliar as ações de marketing">Nível 1:  Ausência de indicadores de desempenho
                                     para avaliar as ações de marketing. 
                                     </option>
                                    <option value="opcao2" 
                                    title="Nível 2:  Utilização de indicadores básicos, mas sem 
                                    uma análise abrangente dos resultados do marketing.">Nível 2:  
                                    Utilização de indicadores básicos, mas sem 
                                    uma análise abrangente dos resultados do marketing.
                                    </option>
                                    <option value="opcao3" 
                                    title="Nível 3: Utilização de indicadores mais sofisticados,
                                     porém com oportunidade de aprimoramento na definição e acompanhamento.">Nível 3: 
                                     Utilização de indicadores mais sofisticados,
                                     porém com oportunidade de aprimoramento na definição e acompanhamento.
                                      </option>
                                    <option value="opcao4" 
                                    title="Nível 4: Utilização de uma variedade de indicadores 
                                    ...
                                    forma precisa.">Nível 4: Utilização de uma variedade de indicadores 
                                    abrangentes, incluindo métricas financeiras, de engajamento e de 
                                    satisfação do cliente, para avaliar a eficácia das ações de marketing de 
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="opcao-select"
                                    ...
                                    <option disabled selected value>Selecione uma resposta</option>
                                    <option value="opcao1" 
                                    title="Nível 1: Ausência de sistema de gestão do
                                     relacionamento com o cliente.">Nível 1: Ausência de sistema de gestão do
                                     relacionamento com o cliente. </option>
                                    <option value="opcao2" 
                                    title="Nível 2:  Sistema básico de gestão do relacionamento
                                    com o cliente, porém inconsistente e pouco eficaz.">Nível 2:  Sistema básico de 
                                    gestão do relacionamento
                                    com o cliente, porém inconsistente e pouco eficaz.</option>
                                    <option value="opcao3" 
                                    title="Nível 3: Sistema implementado de forma regular, mas 
                                    com espaço para melhorias na eficiência.">Nível 3: Sistema implementado de forma regular, mas 
                                    com espaço para melhorias na eficiência.</option>
                                    <option value="opcao4" 
                                    title="Nível 4: Sistema avançado e estratégico de gestão 
                                    do relacionamento com o cliente, visando aprimorar interações, atendimento e 
                                    fidelização.">Nível 4: Sistema avançado e estratégico de gestão 
                                    do relacionamento com o cliente, visando aprimorar interações, atendimento e 
                                    fidelização.</option>
                                </select>
                            </td>
