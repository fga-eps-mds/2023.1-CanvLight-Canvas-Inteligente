          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option value="opcao1" 
                title="Nível 1: A área de Recursos Humanos não possui uma visão e
                  missão claras e não há políticas ou diretrizes estabelecidas.">
                  Nível 1: A área de Recursos Humanos não possui uma visão e
                  missão claras e não há políticas ou diretrizes estabelecidas.
                </option>
                <option value="opcao2" 
                title="Nível 2: A área de Recursos Humanos tem uma visão e missão
                ...
                <option value="opcao3" 
                title="Nível 3: A área de Recursos Humanos possui uma visão e missão
                ...
                <option value="opcao4" 
                title="Nível 4:A área de Recursos Humanos tem uma visão e missão bem
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: A estratégia de RH não está claramente alinhada com
                ...
                <option value="opcao2" 
                title="Nível 2: Existe uma consciência de que a estratégia de RH deve
                ...
                <option value="opcao3" 
                title="Nível 3: A estratégia de RH está em processo de alinhamento
                ...
                <option value="opcao4" 
                title="Nível 4: A estratégia de RH está plenamente alinhada com os
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title=" Nível 1: A empresa não possui um planejamento de sucessão e
                ...
                <option value="opcao2" 
                title="Nível 2: A empresa reconhece a importância do planejamento de
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa possui um planejamento de sucessão e
                ...
                <option value="opcao4" 
                title=" Nível 4: A empresa possui um planejamento de sucessão e
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: O processo de recrutamento e seleção na empresa é
                ...
                <option value="opcao2" 
                title="Nível 2: A empresa possui um processo básico de recrutamento e
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa possui um processo de recrutamento e
                ...
                <option value="opcao4" 
                title="Nível 4: A empresa possui um processo de recrutamento e
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: A empresa não possui critérios claros para avaliar e
                ...
                <option value="opcao2" 
                title="Nível 2: A empresa utiliza critérios básicos para avaliar e
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa utiliza critérios sólidos para avaliar e
                ...
                <option value="opcao4" 
                title="Nível 4: A empresa utiliza critérios específicos e bem
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title=" Nível 1: A empresa não possui programas de treinamento e
                ...
                <option value="opcao2" 
                title="Nível 2: A empresa oferece treinamentos básicos e genéricos
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa oferece programas de treinamento e
                ...
                <option value="opcao4" 
                title="Nível 4: A empresa possui uma ampla variedade de programas de
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: A empresa não possui um plano de carreira ou
                ...
                <option value="opcao2" 
                title=" Nível 2: A empresa possui um plano de carreira básico, mas as
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa possui um plano de carreira definido, com
                ...
                <option value="opcao4" 
                title="  Nível 4: A empresa possui um plano de carreira estruturado,
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: A empresa não possui um processo formal de avaliação
                ...
                <option value="opcao2" 
                title="Nível 2: DA empresa realiza avaliações esporádicas do clima
                  ...
                  saudável.">
                  Nível 2: A empresa realiza avaliações esporádicas do clima
                  organizacional, mas a abordagem é limitada e não abrange todos
                  os aspectos relevantes. A gestão de conflitos é reativa,
                  lidando apenas com problemas evidentes, e não há uma
                  estratégia clara para promover um ambiente de trabalho
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa realiza avaliações periódicas do clima
                ...
                <option value="opcao4" 
                title="  Nível 4: A empresa realiza avaliações frequentes e abrangentes
          ...
          <tr>
            ...
            <td>
              <select className="opcao-select"
                ...
                <option disabled selected value>Selecione uma resposta</option>
                <option value="opcao1" 
                title="Nível 1: A empresa não possui práticas de gestão de pessoas
                ...
                <option value="opcao2" 
                title="Nível 2: A empresa adota algumas práticas de gestão de pessoas
                ...
                <option value="opcao3" 
                title="Nível 3: A empresa possui práticas de gestão de pessoas para
                ...
                <option value="opcao4" 
                title=" Nível 4: GA empresa adota práticas avançadas de gestão de
                  ...
                  mercado.">
                  Nível 4: A empresa adota práticas avançadas de gestão de
                  pessoas, focadas na motivação e engajamento dos colaboradores,
                  como programas de reconhecimento, desenvolvimento de carreira
                  e feedback regular. O sistema de remuneração e benefícios é
                  competitivo e equitativo, alinhado com as melhores práticas do
