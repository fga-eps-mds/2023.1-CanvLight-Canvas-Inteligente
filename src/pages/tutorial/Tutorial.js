    ...
    <div className="tut_body">
      ...
      <div className="tutoriais">
        <div id="tut_introducao" className="introducao">
          <h2>
            • Gerador de Canvas de Negócio: Crie, Visualize e Baixe seu Canvas
            com Facilidade!
          </h2>
          <p>
            Bem-vindo ao nosso tutorial sobre o Gerador de Canvas de Negócio!
            Com esta ferramenta, você poderá criar o seu próprio Canvas de forma
            fácil e eficiente. Para começar, é necessário responder a cada
            módulo individualmente.
            <br />
            Na página inicial, você encontrará um botão chamado "Gerar Canvas".
            Ao clicar neste botão, você será redirecionado para uma nova aba,
            onde poderá preencher as informações necessárias. Nessa página, você
            encontrará quatro botões: Intuição, Observação, Interação e
            Confirmar.
            <br />
            <br />
            ...
            consumidores. Isso ajudará você a entender melhor o contexto em que
            o seu negócio está inserido e a identificar oportunidades.
            <br />
            ...
            clientes, parceiros e fornecedores. Analise os canais de
            comunicação, as estratégias de marketing e as formas de entrega do
            ...
            parte do Canvas. Repita o mesmo processo para os módulos de
            Observação e Interação, preenchendo os formulários e clicando no
            ...
            <br />
            Por fim, você poderá baixar o seu Canvas de Negócio, Assim, você
            terá em mãos uma poderosa ferramenta para planejar e visualizar a
            estrutura e os elementos-chave do seu negócio.
            <br />
            Não hesite em explorar todas as funcionalidades do nosso Gerador de
            Canvas de Negócio para obter insights valiosos e organizar suas
            ideias de maneira eficaz. Boa sorte na criação do seu Canvas!
            <br />
            Para ajudar você a preencher cada campo do questionário, abaixo
        ...
        <div id="tut_dna" className="tut_dna">
          ...
          <p>
            ...
            clientes, concorrentes, marketing, operações, recursos humanos,
            entre outras. Liste essas áreas na primeira coluna da tabela. <br />
            Passo 2: Identifique os atributos de cada área Para cada área
            listada, pense nos atributos ou características específicas que são
            importantes para o seu negócio. Por exemplo, se a área for
            "produtos/serviços", os atributos podem incluir qualidade, inovação,
            preço, entre outros. Liste esses atributos na segunda coluna da
            tabela, ao lado da área correspondente.
            ...
            baixa importância e 5 representa alta importância. Preencha a
            terceira coluna da tabela com essas avaliações.
          </p>
        </div>
        <div id="tut_ikigai" className="tut_ikigai">
          ...
          <p>
            ...
            missão, profissão e vocação. Vamos seguir alguns passos para
            preencher sobre o "ikigai" do negócio: <br />
            <br />
            ...
            Passo 3: Identifique a profissão, as habilidades e competências em
            que o negócio é bom. <br />
        ...
        <div id="tut_fourps" className="tut_fourps">
          ...
          <p>
            A tabela dos 4 P's do negócio é uma ferramenta de marketing usada
            para analisar e planejar estratégias relacionadas aos principais
            elementos de marketing de um produto ou serviço. Os 4 P's são:
            Produto, Preço, Praça (ou Distribuição) e Promoção. Vamos seguir
            alguns passos para preencher a tabela: <br />
            <br />
            ...
            <br />
            Passo 5: Planeje a Promoção: estratégias de marketing para promover
            o produto.
            <br />
        ...
        <div id="tut_benchmaking" className="tut_benchmaking">
          ...
          <p>
            ...
            desempenho de um negócio em relação aos concorrentes ou referências
            do setor. Isso ajuda a identificar pontos fortes, fraquezas e
            ...
            <br />
            Passo 2: Selecione empresas de referência relevantes. Colete os
            dados de benchmark para cada métrica e empresa.
            <br />
            Passo 3: Compare os dados coletados e analise o desempenho do seu
            negócio em relação aos concorrentes ou referências.
            <br />
            Passo 4: Identifique oportunidades de melhoria com base na
            comparação.
            <br />
        ...
        <div id="tut_perfis_cliente" className="tut_perfis_cliente">
          ...
          <p>
            Uma tabela de perfis dos clientes é uma ferramenta útil para
            entender melhor quem são seus clientes, seus interesses,
            necessidades e características. Vamos seguir alguns passos para
            ...
            identificados.
            <br />
            Passo 5: Utilize os perfis dos clientes para direcionar suas ações
            de marketing.
            <br />
            Passo 6: Atualize e revise a tabela periodicamente para acompanhar
            as mudanças no público-alvo.
          </p>
        </div>
        ...
        <div id="tut_conceito" className="tut_conceito">
          ...
          <p>
            ...
            oportunidades, indicado para, orientações de uso e resultado
            esperado.
            <br />
        ...
        <div id="tut_modelo" className="tut_modelo">
          <h2>• Modelo</h2>
          <p>
            Uma tabela de modelo é uma ferramenta útil para descrever e
            organizar informações sobre diferentes modelos, estruturas ou
            abordagens. Vamos seguir alguns passos para preencher essa tabela:{" "}
            <br />
            <br />
            Passo 1: Identifique as colunas da tabela: ferramentas, indicado
            para, orientações de uso e resultado esperado.
            <br />
            Passo 2: Preencha a coluna "ferramentas" com as ferramentas,
            recursos ou metodologias necessárias para usar o modelo.
            <br />
        ...
        <div id="tut_prototipo" className="tut_prototipo">
          ...
          <p>
            ...
            organizar informações sobre diferentes protótipos ou versões
            iniciais de um produto ou projeto. Vamos seguir alguns passos para
            preencher essa tabela:
            <br />
            <br />
            Passo 1: Identifique as colunas da tabela: ferramentas, indicado
            ...
            <br />
            Passo 2: Preencha a coluna "ferramentas" com as ferramentas,
            recursos ou materiais necessários para construir o protótipo.
            <br />
            ...
            <br />
            Passo 5: Preencha a coluna "resultado esperado" descrevendo o
            objetivo ou resultado esperado ao utilizar o protótipo.
          </p>
        </div>
        <div id="tut_analise_custo" className="tut_analise_custo">
          ...
          <p>
            ...
            <br />
            Passo 3: Preencha a coluna "preço" com o preço unitário de cada
            item.
            <br />
            Passo 4: Preencha a coluna "quantidade" com a quantidade necessária
            de cada item.
            <br />
            ...
            <br />
            Passo 6: Some os valores da coluna "custo" para obter o custo total
            do projeto, produto ou atividade.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p>
            ...
            para calcular e comparar os custos de diferentes itens ou
            componentes em um projeto, produto ou atividade. Vamos seguir alguns
            passos para preencher essa tabela:
            <br />
            <br />
        ...
        <div id="tut_mvp" className="tut_mvp">
          ...
          <p>
            ...
            pode ser lançada para validar uma ideia de negócio. Siga estes
            ...
            <br />
            Passo 4: Preencha a coluna "orientações de uso" fornecendo
            instruções sobre como utilizar o produto mínimo viável.
            <br />
        ...
        <div id="tut_fomacao_preco" className="tut_formacao_preco">
          ...
          <p>
            Uma tabela de formação do preço é uma ferramenta útil para calcular
            e estabelecer o preço de venda de um produto ou serviço. Siga estes
            passos para preencher a tabela:
            <br />
            <br />
            ...
            <br />
            Passo 3: Na coluna "custo", insira o valor monetário correspondente
            ao custo de cada item listado na coluna "descrição" e calcule o
            custo total.
            <br />
        ...
        <div id="tut_digitalizacao" className="tut_digitalizacao">
          ...
          <p>
            ...
            aspectos do seu negócio. Siga estes passos para preencher o
            checklist:
            <br />
            <br />
            Passo 1: Marque na tabela as redes em que seu negócio se faz
            presente.
            <br />
        ...
        <div id="tut_canais_venda" className="tut_canais_venda">
          ...
          <p>
            Os canais de venda são uma parte fundamental de um modelo de negócio
            e desempenham um papel crucial no processo de levar um produto ou
            serviço até os clientes. Eles representam os diferentes caminhos
            pelos quais uma empresa se conecta com seu mercado-alvo e entrega
            valor. Siga estes passos para preencher a tabela:
            <br />
            <br />
            Passo 1: Identifique as colunas da tabela: canal, objetivo e
            métrica.
            <br />
